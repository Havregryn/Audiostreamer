//
//  AUTransceiverAudioUnit.m
//  AUTransceiver
//
//  Created by Hallgrim Bratberg on 08/08/2021.
//

#import "AUTransceiverAudioUnit.h"
...
@interface AUTransceiverAudioUnit ()
...
@implementation AUTransceiverAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[AUTransceiverDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block AUTransceiverDSPKernelAdapter * kernelAdapter = _kernelAdapter;
